...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".content {\n  display: grid;\n  grid-template-columns: repeat(4, 1fr);\n  grid-template-rows: 0.6fr 0.1fr repeat(2, 1.9fr) 0.5fr;\n  gap: 10px 10px;\n  grid-template-areas:\n    \"nav nav nav nav\"\n    \"title title title title\"\n    \"main main main main\"\n    \"main main main main\"\n    \"footer footer footer footer\";\n  margin: 0 auto;\n}\n\n.content * {\n  margin: 0 20px;\n}\n\nnav {\n  grid-area: nav;\n  border-bottom: 2px solid;\n  border-color: red;\n  min-height: 50px;\n  padding: 20px;\n  font-size: 40px;\n  position: relative;\n  display: flex;\n  flex-direction: row;\n  flex-wrap: nowrap;\n  justify-content: space-between;\n  align-items: normal;\n  align-content: normal;\n}\n\nh3 {\n  margin: 0;\n}\n\n.tabsContainer {\n  /* float: right;\n  position: absolute;\n  bottom: 0;\n  right: 50px; */\n}\n\nh3,\n.tabsContainer {\n  display: block;\n  flex-grow: 0;\n  flex-shrink: 1;\n  flex-basis: auto;\n  align-self: auto;\n  order: 0;\n  margin-right: 100px;\n}\n\nbutton {\n  box-shadow: inset 0 1px 0 0 #fff;\n  background: linear-gradient(to bottom, #fff 5%, #f6f6f6 100%);\n  background-color: #fff;\n  border-radius: 6px;\n  border: 1px solid #dcdcdc;\n  display: inline-block;\n  cursor: pointer;\n  color: #666;\n  font-size: 15px;\n  font-weight: bold;\n  padding: 6px 24px;\n  text-decoration: none;\n  text-shadow: 0 1px 0 #fff;\n}\n\nbutton:hover {\n  background: linear-gradient(to bottom, #f6f6f6 5%, #fff 100%);\n  background-color: #f6f6f6;\n}\n\nbutton:active {\n  position: relative;\n  top: 1px;\n}\n\n.title {\n  grid-area: title;\n  display: grid;\n  justify-items: center;\n  margin-bottom: 20px;\n}\n\n.grid {\n  display: grid;\n  grid-template-columns: repeat(3, 1fr);\n  grid-template-rows: repeat(2, 1fr);\n  gap: 30px 30px;\n  grid-template-areas:\n    \"module module module\"\n    \"module module module\";\n  grid-area: main;\n}\n\n.main {\n  display: grid;\n  grid-template-columns: 0.8fr 1.2fr;\n  grid-template-rows: 1fr;\n  gap: 0 0;\n  grid-template-areas: \"intro image\";\n  grid-area: main;\n}\n\n.intro {\n  grid-area: intro;\n  padding: 30px;\n}\n\n.image {\n  grid-area: image;\n  padding: 30px;\n}\n\n.module {\n  display: grid;\n  align-items: center;\n  justify-items: center;\n  color: gray;\n\n  /* padding: 10px 0; */\n  max-width: 300px;\n}\n\nh2 {\n  padding: 10px 0;\n}\n\nspan + p {\n  text-align: justify;\n  padding: 10px 20px;\n}\n\nh1 + p {\n  text-align: justify;\n  padding-top: 10px;\n  font-size: 20px;\n}\n\nul {\n  padding-left: 10px;\n  font-size: 18px;\n}\n\nfooter {\n  grid-area: footer;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  position: relative;\n}\n\nfooter > p {\n  position: absolute;\n  bottom: 0%;\n}\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,aAAa;EACb,qCAAqC;EACrC,sDAAsD;EACtD,cAAc;EACd;;;;;iCAK+B;EAC/B,cAAc;AAChB;;AAEA;EACE,cAAc;AAChB;;AAEA;EACE,cAAc;EACd,wBAAwB;EACxB,iBAAiB;EACjB,gBAAgB;EAChB,aAAa;EACb,eAAe;EACf,kBAAkB;EAClB,aAAa;EACb,mBAAmB;EACnB,iBAAiB;EACjB,8BAA8B;EAC9B,mBAAmB;EACnB,qBAAqB;AACvB;;AAEA;EACE,SAAS;AACX;;AAEA;EACE;;;gBAGc;AAChB;;AAEA;;EAEE,cAAc;EACd,YAAY;EACZ,cAAc;EACd,gBAAgB;EAChB,gBAAgB;EAChB,QAAQ;EACR,mBAAmB;AACrB;;AAEA;EACE,gCAAgC;EAChC,6DAA6D;EAC7D,sBAAsB;EACtB,kBAAkB;EAClB,yBAAyB;EACzB,qBAAqB;EACrB,eAAe;EACf,WAAW;EACX,eAAe;EACf,iBAAiB;EACjB,iBAAiB;EACjB,qBAAqB;EACrB,yBAAyB;AAC3B;;AAEA;EACE,6DAA6D;EAC7D,yBAAyB;AAC3B;;AAEA;EACE,kBAAkB;EAClB,QAAQ;AACV;;AAEA;EACE,gBAAgB;EAChB,aAAa;EACb,qBAAqB;EACrB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,qCAAqC;EACrC,kCAAkC;EAClC,cAAc;EACd;;0BAEwB;EACxB,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,kCAAkC;EAClC,uBAAuB;EACvB,QAAQ;EACR,kCAAkC;EAClC,eAAe;AACjB;;AAEA;EACE,gBAAgB;EAChB,aAAa;AACf;;AAEA;EACE,gBAAgB;EAChB,aAAa;AACf;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,qBAAqB;EACrB,WAAW;;EAEX,qBAAqB;EACrB,gBAAgB;AAClB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA;EACE,mBAAmB;EACnB,iBAAiB;EACjB,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,eAAe;AACjB;;AAEA;EACE,iBAAiB;EACjB,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,kBAAkB;AACpB;;AAEA;EACE,kBAAkB;EAClB,UAAU;AACZ","sourcesContent":[".content {\n  display: grid;\n  grid-template-columns: repeat(4, 1fr);\n  grid-template-rows: 0.6fr 0.1fr repeat(2, 1.9fr) 0.5fr;\n  gap: 10px 10px;\n  grid-template-areas:\n    \"nav nav nav nav\"\n    \"title title title title\"\n    \"main main main main\"\n    \"main main main main\"\n    \"footer footer footer footer\";\n  margin: 0 auto;\n}\n\n.content * {\n  margin: 0 20px;\n}\n\nnav {\n  grid-area: nav;\n  border-bottom: 2px solid;\n  border-color: red;\n  min-height: 50px;\n  padding: 20px;\n  font-size: 40px;\n  position: relative;\n  display: flex;\n  flex-direction: row;\n  flex-wrap: nowrap;\n  justify-content: space-between;\n  align-items: normal;\n  align-content: normal;\n}\n\nh3 {\n  margin: 0;\n}\n\n.tabsContainer {\n  /* float: right;\n  position: absolute;\n  bottom: 0;\n  right: 50px; */\n}\n\nh3,\n.tabsContainer {\n  display: block;\n  flex-grow: 0;\n  flex-shrink: 1;\n  flex-basis: auto;\n  align-self: auto;\n  order: 0;\n  margin-right: 100px;\n}\n\nbutton {\n  box-shadow: inset 0 1px 0 0 #fff;\n  background: linear-gradient(to bottom, #fff 5%, #f6f6f6 100%);\n  background-color: #fff;\n  border-radius: 6px;\n  border: 1px solid #dcdcdc;\n  display: inline-block;\n  cursor: pointer;\n  color: #666;\n  font-size: 15px;\n  font-weight: bold;\n  padding: 6px 24px;\n  text-decoration: none;\n  text-shadow: 0 1px 0 #fff;\n}\n\nbutton:hover {\n  background: linear-gradient(to bottom, #f6f6f6 5%, #fff 100%);\n  background-color: #f6f6f6;\n}\n\nbutton:active {\n  position: relative;\n  top: 1px;\n}\n\n.title {\n  grid-area: title;\n  display: grid;\n  justify-items: center;\n  margin-bottom: 20px;\n}\n\n.grid {\n  display: grid;\n  grid-template-columns: repeat(3, 1fr);\n  grid-template-rows: repeat(2, 1fr);\n  gap: 30px 30px;\n  grid-template-areas:\n    \"module module module\"\n    \"module module module\";\n  grid-area: main;\n}\n\n.main {\n  display: grid;\n  grid-template-columns: 0.8fr 1.2fr;\n  grid-template-rows: 1fr;\n  gap: 0 0;\n  grid-template-areas: \"intro image\";\n  grid-area: main;\n}\n\n.intro {\n  grid-area: intro;\n  padding: 30px;\n}\n\n.image {\n  grid-area: image;\n  padding: 30px;\n}\n\n.module {\n  display: grid;\n  align-items: center;\n  justify-items: center;\n  color: gray;\n\n  /* padding: 10px 0; */\n  max-width: 300px;\n}\n\nh2 {\n  padding: 10px 0;\n}\n\nspan + p {\n  text-align: justify;\n  padding: 10px 20px;\n}\n\nh1 + p {\n  text-align: justify;\n  padding-top: 10px;\n  font-size: 20px;\n}\n\nul {\n  padding-left: 10px;\n  font-size: 18px;\n}\n\nfooter {\n  grid-area: footer;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  position: relative;\n}\n\nfooter > p {\n  position: absolute;\n  bottom: 0%;\n}\n"],"sourceRoot":""}]);
// Exports
...
function init() {
  container.append(createNav(), (0,_home__WEBPACK_IMPORTED_MODULE_2__.default)(), (0,_page_load__WEBPACK_IMPORTED_MODULE_1__.createFooter)());

  const home = document.getElementById('home');
  home.addEventListener('click', _page_load__WEBPACK_IMPORTED_MODULE_1__.callPage);
  const menu = document.getElementById('menu');
  menu.addEventListener('click', _page_load__WEBPACK_IMPORTED_MODULE_1__.callPage);
  const contact = document.getElementById('contact');
  contact.addEventListener('click', _page_load__WEBPACK_IMPORTED_MODULE_1__.callPage);
}
...
const callPage = (event) => {
  switch (event.target.id) {
    case 'home':
      replaceElem((0,_home__WEBPACK_IMPORTED_MODULE_1__.default)());
      break;
    case 'menu':
      replaceElem((0,_menu__WEBPACK_IMPORTED_MODULE_2__.default)());
      break;
    case 'contact':
      replaceElem((0,_contact__WEBPACK_IMPORTED_MODULE_0__.default)());
      break;
    default:
      break;
  }
